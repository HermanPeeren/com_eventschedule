...
?>
<form action="<?php echo Route::_('index.php?option=com_eventschedule&view=actor&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="actor-form" class="form-validate">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-6">
                                                ...
                                                <?php echo $this->getForm()->renderField('events'); ?>
