...
namespace Yepr\Component\EventSchedule\Administrator\View\Sections;
...
use Yepr\Component\EventSchedule\Administrator\Model\SectionsModel;

/**
 * View class for a list of Sections.
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EVENTSCHEDULE_MANAGER_SECTIONS'), 'address sections');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			$childBar->standardButton('featured')
				->text('JFEATURE')
				->task('sections.featured')
				->listCheck(true);
			$childBar->standardButton('unfeatured')
				->text('JUNFEATURE')
				->task('sections.unfeatured')
				->listCheck(true);
			...
			{
				$childBar->delete('sections.delete')
