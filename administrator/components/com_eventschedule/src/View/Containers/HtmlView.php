...
namespace Yepr\Component\EventSchedule\Administrator\View\Containers;
...
use Yepr\Component\EventSchedule\Administrator\Model\ContainersModel;

/**
 * View class for a list of Containers.
 */
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_EVENTSCHEDULE_MANAGER_CONTAINERS'), 'address containers');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			$childBar->standardButton('featured')
				->text('JFEATURE')
				->task('containers.featured')
				->listCheck(true);
			$childBar->standardButton('unfeatured')
				->text('JUNFEATURE')
				->task('containers.unfeatured')
				->listCheck(true);
			...
			{
				$childBar->checkin('containers.checkin')->listCheck(true);
			}
			...
			{
				$childBar->delete('containers.delete')
