...
namespace Yepr\Component\EventSchedule\Administrator\View\Actor;
...
use Yepr\Component\EventSchedule\Administrator\Model\ActorModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title($isNew ? Text::_('COM_EVENTSCHEDULE_MANAGER_ACTOR_NEW') : Text::_('COM_EVENTSCHEDULE_MANAGER_ACTOR_EDIT'), 'address actor');
		...
		if ($isNew) {
			...
			//if ($canDo->get('core.create')) {
				$toolbarButtons[] = ['save2copy', 'actor.save2copy'];
			//}
			...
			if (Associations::isEnabled() && ComponentHelper::isEnabled('com_associations')) {
				ToolbarHelper::custom('actor.editAssociations', 'contract', 'contract', 'JTOOLBAR_ASSOCIATIONS', false, false);
			}
