...
namespace Yepr\Component\EventSchedule\Administrator\View\Container;
...
use Yepr\Component\EventSchedule\Administrator\Model\ContainerModel;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title($isNew ? Text::_('COM_EVENTSCHEDULE_MANAGER_CONTAINER_NEW') : Text::_('COM_EVENTSCHEDULE_MANAGER_CONTAINER_EDIT'), 'address container');
		...
		if ($isNew) {
			...
			if (Associations::isEnabled() && ComponentHelper::isEnabled('com_associations')) {
				ToolbarHelper::custom('container.editAssociations', 'contract', 'contract', 'JTOOLBAR_ASSOCIATIONS', false, false);
			}
