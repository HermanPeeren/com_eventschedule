...
/-------------------------------------------------------------------------------------------------------/
	...
	@subpackage		EventscheduleHelper.php
...
// [VDM\Joomla\Componentbuilder\Compiler\Power\Autoloader 189] The power autoloader for this project (JPATH_SITE) area.
$power_autoloader = JPATH_SITE . '/components/com_eventschedule/src/Helper/PowerloaderHelper.php';
...
use TLWeb\Joomla\Utilities\StringHelper as UtilitiesStringHelper;
use TLWeb\Joomla\Utilities\JsonHelper;
use TLWeb\Joomla\Utilities\ObjectHelper;
use TLWeb\Joomla\Utilities\FormHelper;
use TLWeb\Joomla\Utilities\GetHelper;
...
/***[JCBGUI.joomla_component.php_helper_site.26.$$$$]***/
...
public static function calculateEventHeight($eventStart, $eventEnd, $slotHeight) {
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_eventschedule/eventschedule.xml";
	...
	public static function getModel(string $type, string $prefix = 'Site',
		string $component = 'eventschedule', array $config = [])
	{
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_eventschedule');

		$parentId = $parent->id;
		$name     = 'com_eventschedule.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_eventschedule', $table, $inherit);
			...
			else
			{
				...
				return Factory::getDbo()->updateObject('#__eventschedule_'.$table, $object, 'id');
			}
		}
		return false;
	}
	 ...
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'eventschedule')
	{
	 ...
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'eventschedule', $unique = true)
	{
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__eventschedule_'.$type.' AS a');
	 ...
	 *
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'eventschedule', $user = 'null')
	{
